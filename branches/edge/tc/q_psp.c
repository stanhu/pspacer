...
"          ESTIMATED_INTERACTIVE=%x\n"
"          +0x%x destination retransmit correction\n"
"          +0x%x source retransmit correction\n"
"          	+%x dual retransmit correction\n"
"          +0x%x fast retransmit correction\n"
...
" back     back-direction psp device and classid (for interactive mode)\n",
	...
	TC_PSP_MODE_RETRANS_DST, TC_PSP_MODE_RETRANS_SRC, 
	TC_PSP_MODE_RETRANS_SRC | TC_PSP_MODE_RETRANS_DST,
	TC_PSP_MODE_RETRANS_FAST);
}
